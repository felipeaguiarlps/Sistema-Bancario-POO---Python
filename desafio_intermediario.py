...
class Cliente:
    ...
    def realizar_trnsacao(self, conta, transacao):
...
class Conta:
    def __init__(self, numero, cliente):
        ...
        def sacar(self, valor):
            ...
            if excedeu_saldo:
                print("\n@@@ Operação não concluida! Você não possui saldo suficiente. @@@")
...
def depositar(clientes):
    ...
    if not conta:
        return
    cliente.realizar_trnsacao(conta, transacao)
...
def criar_conta(numero_conta, clientes, contas):
    ...
    conta = ContaCorrente.nova_conta(
        cliente=cliente, numero=numero_conta
    )
    contas.append(conta)
...
def main():
    ...
    while True:
        ...
        opcao = input("Digite a ação que deseja realizar: ").lower()
